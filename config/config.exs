...
# come back from the JVM before failing. In general you want this time to be
# longer than message_wait_until_crash, so that the GenServer crashes instead
# of the client call failing. 
...
config :datomic_gen_server, timeout_on_call: 6_000
